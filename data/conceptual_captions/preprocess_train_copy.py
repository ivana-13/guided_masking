...
class Conceptual_Caption(td.RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        self.name = os.path.join(corpus_path, 'tsv_files/train2014_obj101-101.tsv')
...
td.LMDBSerializer.save(ds1, os.path.join(corpus_path, 'imgfeats/volta/training_feat_all.lmdb'), write_frequency=5000)
