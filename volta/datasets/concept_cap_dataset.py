...
class ConceptCapLoaderTrain(object):
    ...
    def __init__(
        ...
        if dist.is_available() and local_rank != -1:
            ...
            #lmdb_file = os.path.join(features_path, "trainval_feat.lmdb")
        ...
        caption_path = os.path.join(annotations_path, "train_ann.jsonl")
        ...
        #ds = td.MultiProcessRunner(ds, 5000, 1)
...
class ConceptCapLoaderVal(object):
    ...
    def __init__(
        ...
        caption_path = os.path.join(annotations_path, "valid_ann.jsonl")
        ...
        ds = td.MultiProcessMapDataZMQ(ds, num_proc=1, map_func=preprocess_function, strict = True)
        self.ds = td.BatchData(ds, batch_size)
        self.ds.reset_state()
