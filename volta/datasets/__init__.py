...
from .Open_Images_dataset import Open_Images_ProbesClassificationDataset
from .prefix_testing import PrefixPredictionDataset
...
DatasetMapTrain = {
    ...
    "Foil_verbs": FoilClassificationDataset,
    "SVO-Probes_classification": SVO_ProbesClassificationDataset, 
    "SVO-Probes_guided_masking": SVO_ProbesClassificationDataset, 
    "Open-Images": Open_Images_ProbesClassificationDataset, 
    "V-COCO": Open_Images_ProbesClassificationDataset, 
    "Intention_classification": SVO_ProbesClassificationDataset, 
    "Intention_guided_masking": SVO_ProbesClassificationDataset, 
    "Intention_prefix_masking": PrefixPredictionDataset,
}
