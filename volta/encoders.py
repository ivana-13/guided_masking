...
class BertForVLTasks(BertPreTrainedModel):
    ...
    def forward(
        ...
        vision_logit = 0
        linguistic_prediction = None
        linguisic_logit = 0

        prediction_scores_t, prediction_scores_v_dict, vil_binary_prediction, vqa_score, pooled_output= self.cls(
            encoded_layers_t, encoded_layers_v, pooled_output_t, pooled_output_v
        )
        ...
        if output_all_encoded_layers:
            return vil_binary_prediction, vision_prediction, linguistic_prediction, all_attention_mask, \
